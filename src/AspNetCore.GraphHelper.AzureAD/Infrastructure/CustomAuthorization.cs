...
namespace AspNetCore.GraphHelper.AzureAD.Infrastructure
{
    /// <summary>
    ...
    public class GroupPolicyHandler : AuthorizationHandler<GroupPolicyRequirement>
    {
                                                   ...
                                                   GroupPolicyRequirement requirement)
        {
            ...
            if (UserGroupHelper.CheckUsersGroupMembership(context, requirement.GroupName, _httpContextAccessor))
            {
